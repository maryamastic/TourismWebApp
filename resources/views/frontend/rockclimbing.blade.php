...
<div class="container-fluid bg-primary py-5 mb-5" id="hero-header-rockclimbing">
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Rock Climbing</h1>
                        
                        <p class="fs-4 text-white mb-4 animated slideInDown">Unearth Thrilling Rock Climbing Escapades with TAK Tours</p>
        ...
        <?php
            ...
            $rockclimbingPackages = DB::table('tourpackages')->where('PackageType', 'RockClimbing')->paginate(10);
        ?>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Reach for the Summit , Reaching New Heights in Pakistan</h1>
            </div>
           <!-- Services Start -->
            <div class="row g-4 justify-content-center">
            @foreach($rockclimbingPackages as $package)
        ...
        <div class="pagination" id="parent-container">
            @if($rockclimbingPackages->previousPageUrl())
                <a href="{{ $rockclimbingPackages->previousPageUrl() }}">Previous</a>
            @endif
            @if($rockclimbingPackages->nextPageUrl())
                <a href="{{ $rockclimbingPackages->nextPageUrl() }}">Next</a>
            @endif
        </div>
