...
<div class="container-fluid bg-primary py-5 mb-5" id="hero-header-trekking">
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Trekking</h1>
                        
                        <p class="fs-4 text-white mb-4 animated slideInDown"> Discover the thrill of trekking with us</p>
        ...
        <?php
            ...
            $trekkingPackages = DB::table('tourpackages')->where('PackageType', 'trekking')->paginate(10);
        ?>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Experience the great outdoors like never before through exhilarating treks.
           ...
           <!-- Services Start -->
            ...
            @foreach($trekkingPackages as $package)
        ...
        <div class="pagination" id="parent-container">
            @if($trekkingPackages->previousPageUrl())
                <a href="{{ $trekkingPackages->previousPageUrl() }}">Previous</a>
            @endif
            @if($trekkingPackages->nextPageUrl())
                <a href="{{ $trekkingPackages->nextPageUrl() }}">Next</a>
            @endif
        </div>
