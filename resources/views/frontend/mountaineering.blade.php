...
<div class="container-fluid bg-primary py-5 mb-5" id="hero-header-mountaineering">
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Mountaineering</h1>
                        
                        <p class="fs-4 text-white mb-4 animated slideInDown">Mountaineering Adventures Await in Pakistan</p>
        ...
        <?php
            ...
            $mountaineeringPackages = DB::table('tourpackages')->where('PackageType', 'mountaineering')->paginate(10);
        ?>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Conquer Pakistan's legendary peaks.</h1>
            </div>
           <!-- Services Start -->
            <div class="row g-4 justify-content-center">
            @foreach($mountaineeringPackages as $package)
        ...
        <div class="pagination" id="parent-container">
            @if($mountaineeringPackages->previousPageUrl())
                <a href="{{ $mountaineeringPackages->previousPageUrl() }}">Previous</a>
            @endif
            @if($mountaineeringPackages->nextPageUrl())
                <a href="{{ $mountaineeringPackages->nextPageUrl() }}">Next</a>
            @endif
        </div>
