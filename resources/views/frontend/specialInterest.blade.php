...
<div class="container-fluid bg-primary py-5 mb-5" id="hero-header-specialInterest">
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Special Interests</h1>
                        
                        <p class="fs-4 text-white mb-4 animated slideInDown">Discover Year-Round Adventures in Pakistan</p>
        ...
        <?php
            ...
            $SI_Packages = DB::table('tourpackages')->where('PackageType', 'SpecialInterest')->paginate(10);
        ?>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Explore Special Interests with TAK Tours.
           ...
           <!-- Services Start -->
            ...
            @foreach($SI_Packages as $package)
        ...
        <div class="pagination" id="parent-container">
            @if($SI_Packages->previousPageUrl())
                <a href="{{ $SI_Packages->previousPageUrl() }}">Previous</a>
            @endif
            @if($SI_Packages->nextPageUrl())
                <a href="{{ $SI_Packages->nextPageUrl() }}">Next</a>
            @endif
        </div>
